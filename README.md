...
<html lang="en">
    ...
    justify-content: flex-end;
            ...
            .redd {
                background-color: rgb(17, 188, 86);
            }
            .bluee {
    ...
    <center>
        <h2>
            <font color="blue">SIMPLE CALCULATOR <br><br>
                THIRUMALAI V(212223040229)</font></h2>
...
```
## OUTPUT:
![ex 8](https://github.com/Thirumalai23013035/Calc/assets/153185249/36b2d98a-eb59-4539-acfc-4be460df6019)
![ex 8 b](https://github.com/Thirumalai23013035/Calc/assets/153185249/85e2539e-06de-49f3-b598-d59bcb68614c)
